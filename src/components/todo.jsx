...
var todoListStore = require("../todoStore");
var TodoActions = todoListStore.actions;
    ...
    render: function() {
        ...
        switch(this.props.showing){
            case 'all':
                ...
                break;
            case 'completed':
                filteredList = _.filter(this.props.list,function(item){ return item && item.isComplete; });
                break;
            case 'active':
                filteredList = _.filter(this.props.list,function(item){ return item && !item.isComplete; });
        }
...
var TodoApp = React.createClass({
    ...
    render: function() {
        return (
            <div>
                <TodoHeader />
                <this.props.activeRouteHandler list={this.state.list} showing="all"/>
...
var routes = (
    <Router.Route handler={TodoApp}>
        <Router.Route name="All" path="/" handler={TodoMain} showing="all" />
        <Router.Route name="Completed" path="/completed" handler={TodoMain} showing="completed" />
        <Router.Route name="Active" path="/active" handler={TodoMain} showing="active" />
    </Router.Route>
);
*/
...
//React.render(<TodoApp activeRouteHandler={TodoMain}/>, document.getElementById('todoapp'));
